...
const clientEnvSchema = z.object({
  ...
  NEXT_PUBLIC_TREZOR_MANIFEST_EMAIL: z.string(),
  NEXT_PUBLIC_TREZOR_MANIFEST_APP_URL: z.string(),
...
export const clientEnv = clientEnvSchema.parse({
  ...
  NEXT_PUBLIC_TREZOR_MANIFEST_EMAIL: process.env.NEXT_PUBLIC_TREZOR_MANIFEST_EMAIL,
  NEXT_PUBLIC_TREZOR_MANIFEST_APP_URL: process.env.NEXT_PUBLIC_TREZOR_MANIFEST_APP_URL,
